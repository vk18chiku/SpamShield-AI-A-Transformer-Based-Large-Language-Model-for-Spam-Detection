...
class LayerNorm(nn.Module):
    """Custom LayerNorm kyunki weight loader .scale aur .shift expect kar raha hai"""
...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_in, d_out, num_heads, dropout, qkv_bias=True):
        ...
        # Weight loader exact yahi naam dhundh raha hai
    ...
    def forward(self, x):
        ...
        # Multi-head ke liye reshape aur transpose
...
class FeedForward(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        # Weight loader index [0] aur [2] pe linear layers expect karta hai
...
token_ids = generate_text_simple(
    ...
    max_new_tokens=15,
    context_size=BASE_CONFIG["block_size"]
)
...
text_2 = (
    "Dear Customer,Your bank account has been temporarily suspended due to suspicious activity. "
    "Verify your account immediately to avoid permanent closure:www.secure-bank-verify.comFailure"
    " to verify within 24 hours will result in account termination."
)
